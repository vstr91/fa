 ...
 * VideoGaleria
 *
 * @ORM\Entity(repositoryClass="Fa\SiteBundle\Entity\Repository\VideoGaleriaRepository")
 * @ORM\Table(name="video_galeria")
...
class VideoGaleria {
     ...
     *     mimeTypes = {"video/mp4"},
     *     mimeTypesMessage = "Por favor indique um arquivo MP4 válido")
     */
    private $file;
